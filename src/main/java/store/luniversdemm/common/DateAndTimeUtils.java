...
public class DateAndTimeUtils {
    ...
    public static String durationBetweenTwoTimes(String higher, String lower) {
        int hours = timeFromString(lower).getHour();
        int minutes = timeFromString(lower).getMinute();
        return String.valueOf(minutesFromLocalDate(timeFromString(higher)
                .minusHours(hours)
